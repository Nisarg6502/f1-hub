...
| `GET /api/session_recap` | Race detail page — AI Recap card. Streams Markdown rather than JSON; builds a grounded fact bundle from `race_results` plus OpenF1 race control, then calls Ollama Cloud on a cache miss |
