...
function ModuleEmptyState({
  ...
  return (
    <div className="apex-glass-soft rounded-2xl p-12 flex flex-col items-center justify-center text-center min-h-[500px]">
      <div className="w-14 h-14 rounded-tile bg-primary-container/10 border border-primary-container/25 flex items-center justify-center mb-5">
      ...
      <div className="mt-7 flex gap-3">
        <Link
          ...
          className="font-bold text-xs uppercase tracking-[0.1em] px-6 py-2.5 rounded-control apex-glass-soft hover:border-flame-bright/50 transition-colors"
        >
          Race results
        </Link>
        <Link
          href="/schedule"
          className="font-bold text-xs uppercase tracking-[0.1em] px-6 py-2.5 rounded-control bg-primary-container/16 text-primary hover:bg-primary-container/24 transition-colors"
        >
          View schedule
        </Link>
      </div>
