  ...
  return (
    <div className="px-6 md:px-10 pt-8 pb-16 max-w-[1100px] mx-auto">
      <div className="flex items-center gap-4 mb-7">
        <Link
          href="/"
          className="font-bold text-xs px-4 h-[40px] rounded-control apex-glass-soft flex items-center justify-center hover:border-flame-bright/50 transition-[border-color,transform] duration-150 active:scale-95 flex-none"
        >
          ← APEX
        </Link>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-3.5">
          {completed.map((race) => (
            <Link
              ...
              className="apex-glass-soft rounded-tile px-5 py-[18px] hover:border-flame-bright/50 transition-[border-color,transform] duration-150 active:scale-[0.99] block"
            >
