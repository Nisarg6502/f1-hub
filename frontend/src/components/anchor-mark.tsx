  ...
  return (
    <span className="relative inline">
      <button
        ...
        className="apex-anchor-mark rounded-[3px] px-[1px] text-left underline decoration-[1.5px] underline-offset-[3px] transition-[background-color,text-decoration-thickness] duration-150 [transition-timing-function:cubic-bezier(0.23,1,0.32,1)] hover:decoration-2 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[var(--color-primary)]"
