      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            } left-1/2 -translate-x-1/2 w-56 max-w-[min(14rem,calc(100vw-2rem))] rounded-control bg-surface-container-low/97 border border-white/10 px-3.5 py-2.5 text-xs font-medium leading-snug text-warm-200 shadow-xl pointer-events-none`}
          >
            {content}
          </motion.div>
        )}
