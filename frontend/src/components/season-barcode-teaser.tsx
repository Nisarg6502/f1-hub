...
// Compact, non-interactive teaser of the `/history` 75-Season Barcode for
...
// needs to say "look, 75 seasons of colour" and link through. A server
...
export default function SeasonBarcodeTeaser({ races }: { races: HistoricalRace[] }) {
  ...
  return (
    <Link
      href="/history"
      aria-label="Explore 75 seasons of Formula 1 history"
