  ...
  return (
    <div className={`relative ${className}`}>
      <select
        ...
        className="appearance-none apex-glass-soft rounded-control text-on-background font-bold text-sm py-[13px] pl-4 pr-11 outline-none focus:border-flame-bright/50 transition-colors cursor-pointer w-full md:w-32"
      >
        {years.map((y) => (
