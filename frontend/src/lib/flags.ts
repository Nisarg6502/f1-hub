...
const COUNTRY_TO_FLAG: Record<string, string> = {
  ...
  Italy: "Italy",
  Japan: "Japan",
  /* Round 16 of 2026: the Bahrain Grand Prix is being run at Sepang. The
     country here is the host, Malaysia, which had no entry and therefore no
     flag — the one blank chip in the whole calendar. Asset generated by
     `scripts/make_malaysia_flag.mjs`. */
  Malaysia: "Malaysia",
  Mexico: "Mexico",
  Monaco: "Monaco",
