...
14. Do NOT rank or compare facts the data has not already ranked. No "the smallest margin of the session", "the closest gap", "the biggest surprise" — the bundle pre-ranks `biggest_improvements`, and nothing else is ranked for you.
...
{_FORMAT.format(paragraphs="2-3 short paragraphs, 150-230 words total.")}
...
3. The Q2 and Q1 eliminations, especially anyone in `q2_eliminated`/`q1_eliminated` with a small `gap_to_cutoff`.
